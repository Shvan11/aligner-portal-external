...
const AlignerPortal = () => {
    ...
    const loadAnnouncements = async () => {
        try {
            const { data, error: queryError } = await supabase
                ...
                `)
                .or(`target_doctor_id.is.null,target_doctor_id.eq.${doctor.dr_id}`)
    ...
    const subscribeToAnnouncements = () => {
        console.log('🔔 Subscribing to real-time announcements for doctor:', doctor.dr_id);
        ...
        const subscription = supabase
            ...
            .on('postgres_changes', {
                ...
                filter: `target_doctor_id=eq.${doctor.dr_id}`
            }, (payload) => {
