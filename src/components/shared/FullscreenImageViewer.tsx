/**
 * FullscreenImageViewer - Fullscreen image viewer with keyboard support
 */
...
const FullscreenImageViewer: React.FC<FullscreenImageViewerProps> = ({ photo, onClose }) => {
  ...
  return (
    <div className="fullscreen-viewer" onClick={onClose}>
      ...
      <div className="fullscreen-image-container" onClick={handleContainerClick}>
        <img
      ...
      <div className="fullscreen-photo-info" onClick={handleContainerClick}>
